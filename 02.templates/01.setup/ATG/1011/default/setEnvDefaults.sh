...
export SUIF_SETUP_TEMPLATE_MFTSERVER_LICENSE_FILE=${SUIF_SETUP_TEMPLATE_MFT_GTW_LICENSE_FILE:-"/provide/path/to/MFTGTW-license.xml"}
...
export SUIF_INSTALL_IS_MAIN_HTTPS_PORT=${SUIF_INSTALL_IS_MAIN_HTTPS_PORT:-"5543"}
export SUIF_INSTALL_IS_DIAGS_HTTP_PORT=${SUIF_INSTALL_IS_DIAGS_HTTP_PORT:-"9999"}

## AT related
export SUIF_INSTALL_MFTGW_PORT=${SUIF_INSTALL_MFTGW_PORT:-"8500"}

export SUIF_SETUP_TEMPLATE_IS_LICENSE_FILE_UrlEncoded=$(urlencode ${SUIF_SETUP_TEMPLATE_IS_LICENSE_FILE})
export SUIF_SETUP_TEMPLATE_MFT_GTW_LICENSE_FILE_UrlEncoded=$(urlencode ${SUIF_SETUP_TEMPLATE_MFT_GTW_LICENSE_FILE})
