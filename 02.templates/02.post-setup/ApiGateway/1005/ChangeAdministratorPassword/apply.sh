...
URL="${SUIF_APIGW_URL_PROTOCOL}://${SUIF_APIGW_DOMAINNAME}:${SUIF_APIGW_SERVICE_PORT}/rest/apigateway/users/Administrator"
...
curlCmd="${curlCmd}${SUIF_APIGW_OLD_ADMINISTRATOR_PASSWORD}"
